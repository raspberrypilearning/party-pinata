...
Κάνε κλικ στην καρτέλα **Ήχοι** για το αντικείμενο **Πινιάτα** και θα βρεις έναν ήχο **Boing**. Κάνε κλικ στο εικονίδιο **Αναπαραγωγή** για να μπορείς να ακούσεις τον ήχο.
...
![Το μπλοκ Μεταβλητές με του νέο μπλοκ «χτυπήματα».](images/variable-blocks.png)
