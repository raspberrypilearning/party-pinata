...
اسحب كتلة`اجعل متغير"ضربات" مساوياً 0`{:class="block3variables"} الى النص البرمجي الاول، بين كتلة `غير المظهر الى`{:class="block3looks"} وكتلة `اذهب الى س: (0) ص: (180)`{:class="block3motion"}.
...
افتح قائمة الكتل البرمجية `التحكم`{:class="block3control"}. اسحب كتلة `إذا`{:class="block3control"} في منطقة التعليمات البرمجية اسفل كتلة `عند نقر هذا الكائن`{:class="block3events"}:
...
**اختبار:** قم بتشغيل مشروعك. قم بضرب البنياتا 10 مرات لسماع الصوت وتاكد بان عدد `الضربات`{:class="block3variables"} يزيد عند كل ضربة مقدار 1.
...
ستبدو كتلة البث على النحو التالي:
